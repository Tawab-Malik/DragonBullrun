...
export default function Dragons() {
    return (
        <>
            <section className=" bg-dragon-bg bg-cover bg-center">
                <div className=" max-w-8xl mx-5 xl:mx-auto space-y-24 xl:space-y-48 py-36 ">
                    <div className=" space-y-10">
                        <h2 className=" text-text-orange text-start xl:text-center text-5xl xl:text-[70px] font-dragonslapper uppercase">THE DRAGONS REALM</h2>
                    ...
                    <div>
                        ...
                        <div className=" grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-10 place-items-center">
                            ...
                            {/* 1st card*/}
                            <div className="w-full xl:h-[560px] h-auto xl:w-[530px] space-y-5 xl:space-y-10 p-5 xl:p-10 shadow-inner border-[12px] rounded-[46px] border-box-border border-opacity-65 bg-text-black bg-opacity-65">
                            ...
                            {/* 3st card*/}
                            <div className="w-full xl:h-[560px] h-auto xl:w-[530px] space-y-5 xl:space-y-10 p-5 xl:p-10 shadow-inner border-[12px] rounded-[46px] border-box-border border-opacity-65 bg-text-black bg-opacity-65 hidden 2xl:block">
