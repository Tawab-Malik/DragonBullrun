                              ...
                              <div className=" max-w-[1400px] mx-5 2xl:mx-auto brightness-100 ">
                                    ...
                                    <div className="brightness-100 ">
                                          ...
                                          <div className=" flex gap-5 items-center justify-center">
                                                ...
                                                <MdOutlineFileCopy className=" size-10 md:size-7 hover:text-text-orange duration-500 cursor-pointer text-white" onClick={() => copyToClipboard(' 0xC955faa 911D7507aEE0c0d7a2d5a 79c79a041AB8')} />
                                          ...
                                          <div className=" flex items-center justify-center py-3">
                                                <div className=" bg-progress-brown rounded-full px-5 py-3 md:py-4">
                                                      <div className=" w-full md:w-[500px] xl:w-[1150px] overflow-hidden rounded-full    flex justify-start items-center">
                                                            <div
                                          ...
                                          <div className=" flex justify-center py-5">
                                                <Link><Button className=" px-7  md:!px-9 py-6 md:!py-8 bg-text-orange rounded text-xl md:text-3xl text-nav-black uppercase font-dragonslapper hover:scale-110 ">join presale</Button></Link>
                                          </div>
